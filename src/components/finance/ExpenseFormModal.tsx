      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative">
            <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-2xl font-bold text-zinc-400">
              ₹
            </span>
            <input
              type="number"
              ...
              placeholder="0.00"
              className="w-full pl-9 pr-4 py-3 text-2xl font-bold font-mono tracking-tight bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="grid grid-cols-4 gap-2 max-h-44 overflow-y-auto p-1 bg-zinc-50 dark:bg-zinc-800/40 rounded-xl border border-zinc-200/60 dark:border-zinc-700/60">
                ...
                <div className="flex items-center gap-1.5 flex-wrap mt-1">
                  {tags.map((t) => (
                    <span
                      ...
                      className="px-2 py-0.5 bg-zinc-200 dark:bg-zinc-700 text-zinc-800 dark:text-zinc-200 rounded-md cursor-pointer hover:bg-rose-100 dark:hover:bg-rose-900/60 hover:text-rose-600 transition-colors"
        ...
        <div className="flex items-center justify-end gap-2 pt-2 border-t border-zinc-100 dark:border-zinc-800">
          ...
          <Button type="submit" variant="primary">
            {initialTransaction ? 'Update Expense' : 'Save Expense'}
          </Button>
        </div>
      </form>
    </Modal>
