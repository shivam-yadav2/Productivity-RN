      ...
      <View className="flex-col gap-4">
        ...
        <View className="flex-col gap-1">
          ...
          <View className="relative justify-center">
            <Text className="absolute left-3.5 z-10 text-2xl font-bold text-zinc-400">₹</Text>
            <TextInput
              ...
              className="w-full pl-9 pr-4 py-3 text-2xl font-bold tracking-tight bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-zinc-900 dark:text-zinc-100"
            />
          </View>
        </View>
        ...
        <View className="flex-col gap-1.5">
          <Text className="text-xs font-bold uppercase tracking-wider text-zinc-500">Category</Text>
          <ScrollView
            style={{ maxHeight: 176 }}
                ...
                return (
                  <Pressable
                    ...
                    className={cn(
                      ...
                      isSelected ? 'bg-rose-500' : 'active:bg-zinc-200/60 dark:active:bg-zinc-700/60'
                    )}
                    style={{ width: '23%' }}
                  >
        ...
        {/* Account Selector */}
        <View className="flex-col gap-1.5">
          <Text className="text-xs font-bold uppercase tracking-wider text-zinc-500">Paid From Account</Text>
                ...
                <View className="flex-row items-center gap-1.5 flex-wrap mt-1">
                  {tags.map((t) => (
                    <Pressable
                      ...
                      className="px-2 py-0.5 bg-zinc-200 dark:bg-zinc-700 rounded-md active:bg-rose-100 dark:active:bg-rose-900/60"
                    >
                      <Text className="text-xs text-zinc-800 dark:text-zinc-200">#{t} ×</Text>
                    </Pressable>
                  ))}
                </View>
              )}
